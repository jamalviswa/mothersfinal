                                ...
                                <div class="col-md-12">
                                    <div class="m-section__content borderr">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label class="col-md-3 offset-md-6" style="text-align:center;">
                                                Authorised Signatory
                                            </label>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-6 offset-md-3">
                                                <span class="red">* </span>This is computer generated receipt no signature required
                                            </label>
                                    ...
                                    <?php
                                    $user_id = $detail['customer_id'];
                                    ?>
                                    <div class="download_pdf">
                                        <a rel="tooltip" class="btn btn-secondary m-btn m-btn--air m-btn--custom" title="Download Invoice" href="{{ route("receipts.invoicepdf", ['customer_id'=>$user_id]) }}" target="_blank" download>
